...
- [ ] [BRIEF-17] `--json` on a dispatched refusal (BRIEF-07/09/15/19) prints `specs/output.spec.md`'s envelope, the sentence as `message`, `reason` from the table below (see E-BRIEF-11).
